 ...
 */
@Entity
@Table(name = "CORREOS", catalog = "agenda2", schema = "")
@NamedQueries({
...
public class Correos implements Serializable {
    ...
    public void setContactos(Contactos contactos) {
        Contactos oldContactos = this.contactos;
        this.contactos = contactos;
        changeSupport.firePropertyChange("contactos", oldContactos, contactos);
    }
    ...
    public String toString() {
        return "correos.Correos[correoId=" + correoId + "]";
    }
